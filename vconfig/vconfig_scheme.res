...
Scheme 
{
	...
	Colors
	{
		...
		"Black"      "0 0 0 255"  
		"Blank"      "0 0 0 0"  
		"BaseText"      "170 170 170 255"    //base colors    used in text windows, lists
		"BrightBaseText"      "224 224 224 255"    //brightest text
		"SelectedText"      "224 224 240 255"    //selected text
		"DimBaseText"      "170 170 170 255"    //dim base text
		"LabelDimText"      "160 160 160 255"    //used for info text
		"ControlText"      "200 200 200 255"    //used in all text controls
		"BrightControlText"      "171 186 204 255"    //use for selected controls
		"DisabledText1"      "112 112 112 255"    //disabled text
		"DisabledText2"      "40 40 40 255"    //overlay color for disabled text (to give that inset look)
		"DimListText"      "117 134 102 255"    //offline friends, unsubscribed games, etc.
		"ControlBG"      "54 54 54 255"    //background colors    background color of controls
		"ControlDarkBG"      "68 68 68 255"    //darker background color; used for background of scrollbars
		"WindowBG"      "36 36 36 255"    //background color of text edit panes (chat, text entries, etc.)
		"SelectionBG"      "79 82 89 255"    //background color of any selected text or menu item
		"SelectionBG2"      "46 50 56 255"    //selection background in window w o focus
		"ListBG"      "36 36 36 255"    //background of server browser, buddy list, etc.

		//titlebar colors
		"TitleText"      "200 200 200 255"  
		"TitleDimText"      "127 127 127 255"  
		"TitleBG"      "54 54 54 0"  
		"TitleDimBG"      "54 54 54 0"  

		//slider tick colors
		"SliderTickColor"      "127 127 127 255"  
		"SliderTrackColor"      "31 31 31 255"  
		"BorderBright"      "96 96 96 255"    //border colors    the lit side of a control
		"BorderDark"      "31 31 31 255"    //the dark unlit side of a control
...
//		Button.DepressedBgColor			"ControlDarkBG"	
		...
		ComboBoxButton.DisabledBgColor	"ListBG" // ControlBG
		...
		FrameTitleButton.FgColor		"TitleDimText"
		...
		FrameSystemButton.DisabledIcon	"resource/icon_vconfig"
...
//		Tooltip.BgColor				"255 155 0 255"
		...
		TreeView.BgColor			"ListBG"	// "ControlBG"
